...
<head>
    ...
    <script>
       $(document).ready(function(){
        ...
        $.get('Machine/Area2_Machine1/cekMachine1State.php', function(data) {
    ...
    <script>
       $(document).ready(function(){
         setInterval(function(){
            console.log('Inside setInterval function');
        $.get('Machine/Area2_Machine2/cekMachine2State.php', function(data) {
            console.log(data); // check the value of data
            if (data.trim() === 'Active') {
        ...
        $(document).ready(function(){
            setInterval(function(){
                $("#cekMachine1ID").load('Machine/Area2_Machine1/cekMachine1ID.php');
                $("#cekMachine2ID").load('Machine/Area2_Machine2/cekMachine2ID.php');
            }, 1000);
        });
    </script>
...
<body>
    <div class="container">
        ...
        <div class="main-content">
            <div id="icon7">
                <a href="Machine/Area2_Machine1/Machine_1.php"><img id="img1" src="images/Area_Off.png"></a>
                <h1 id="text_img1"><span id ="cekMachine1ID"></span></h1>
            </div>

            <div id="icon8">
            <a href="Machine/Area2_Machine2/Machine_2.php"><img id="img2" src="images/Area_Off.png"></a>
                <h1 id="text_img2"><span id ="cekMachine2ID"></span></h1>
            </div>
            <div id="recap">
                <a href="recaparea2.php"><h1 id="recapText">Recap</h1></a>
            </div>
        </div>
</body>
</html>