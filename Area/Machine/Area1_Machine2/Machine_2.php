...
<head>
    ...
    <link href="css/Machine_2.css" rel="stylesheet"/>
</head>
<body>
    <div class="container">
        <div class="sidebar">
        ...
        <div class="main-content">
            ...
            <section>
                ...
                <p id="text_1">Name:</p>
                <h1 id="Name">
                            <a href="infoMachine2.php"><span id ="ceksensor1"></span></a>
                        </h1>
                            <span id ="ceksensor1"></span>
                    </div>
                ...
                <table class="my-table">
                    ...
                    <tbody>
                        ...
                        $sql = mysqli_query($konek, "SELECT MIN(ID) as min_id FROM area1 WHERE Status='Active'");
                        ...
                        $sql1 = mysqli_query($konek, "SELECT * FROM area1 WHERE ID = $show");
                        $Data = mysqli_fetch_array($sql);
                        $no = 0;
